...
const (
	CVEService_GetCVE_FullMethodName = "/proto.CVEService/GetCVE"
)
...
type CVEServiceClient interface {
	GetCVE(ctx context.Context, in *CVERequest, opts ...grpc.CallOption) (*CVEResponse, error)
}
...
func (c *cveServiceClient) GetCVE(ctx context.Context, in *CVERequest, opts ...grpc.CallOption) (*CVEResponse, error) {
...
type CVEServiceServer interface {
	GetCVE(context.Context, *CVERequest) (*CVEResponse, error)
...
func (UnimplementedCVEServiceServer) GetCVE(context.Context, *CVERequest) (*CVEResponse, error) {
...
func _CVEService_GetCVE_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CVEServiceServer).GetCVE(ctx, req.(*CVERequest))
	}
